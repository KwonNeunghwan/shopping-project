...
<body>
    ...
    <div class="product-container">
        <div class="product-card">
            <img src="/images/kapa-img5.jpg" alt="Product 1" class="product-image">
        ...
        <div class="product-card">
            <img src="/images/kapa-img17.jpg" alt="Product 2" class="product-image">
            <div class="product-info">
        ...
        <div class="product-card">
            <img src="/images/kapa-img22.jpg" alt="Product 3" class="product-image">
            <div class="product-info">
        ...
        <div class="product-card">
            <img src="/images/kapa-img7.jpg" alt="Product 4" class="product-image">
            <div class="product-info">
                <h3><i class="fas fa-tshirt"></i> AS MONACO 2024 어웨이 레플리카 저지</h3>
                <span>기존 가격: 159,000원</span>
                <span class="discount">할인 가격: 111,300원 (-30%)</span>
